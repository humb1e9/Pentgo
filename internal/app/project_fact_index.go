...
func RenderProjectFactIndex(facts []domain.ProjectFact) string {
	ordered := append([]domain.ProjectFact(nil), facts...)
...
func renderProjectFactLine(fact domain.ProjectFact) string {
