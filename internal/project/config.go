...
func DefaultConfig() Config {
	return Config{MaxTurns: 20, Context: ContextConfig{ContextWindow: 128000, ThresholdRatio: .8, RetainRatio: .16, ToolResultThresholdChars: 8192, ToolResultHeadChars: 4096, ToolResultTailChars: 1024, CheckpointMaxTokens: 8192}}
}
