...
- [deserialization-insecure](deserialization-insecure.md) for deeper coverage of Python pickle and general deserialization attack patterns
- [dependency-confusion](dependency-confusion.md) when the ML pipeline has supply chain risks via pip/npm package confusion
