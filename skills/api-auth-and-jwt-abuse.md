...
- For full JWT and OAuth depth: [jwt oauth token attacks](jwt-oauth-token-attacks.md)
- For OAuth or OIDC configuration flaws in browser and SSO flows: [oauth oidc misconfiguration](oauth-oidc-misconfiguration.md)
