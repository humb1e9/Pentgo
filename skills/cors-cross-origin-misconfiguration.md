...
- Session or JSON action abuse: [csrf cross site request forgery](csrf-cross-site-request-forgery.md)
- OAuth token leakage and callback binding: [oauth oidc misconfiguration](oauth-oidc-misconfiguration.md)
