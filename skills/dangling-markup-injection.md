...
- [xss-cross-site-scripting](xss-cross-site-scripting.md) when full XSS is possible (no need for dangling markup)
- [csp-bypass-advanced](csp-bypass-advanced.md) when CSP blocks JS execution — dangling markup bypasses script restrictions
- [csrf-cross-site-request-forgery](csrf-cross-site-request-forgery.md) when dangling markup steals CSRF tokens for subsequent CSRF attacks
