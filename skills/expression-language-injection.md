...
- [ssti-server-side-template-injection](ssti-server-side-template-injection.md) for template engines (Jinja2, FreeMarker, Twig) — different attack surface
- [jndi-injection](jndi-injection.md) when EL evaluation leads to JNDI lookup
