...
- [SQLi SQL Injection](sqli-sql-injection.md)
- [SSRF Server Side Request Forgery](ssrf-server-side-request-forgery.md)
- [XXE XML External Entity](xxe-xml-external-entity.md)
- [SSTI Server Side Template Injection](ssti-server-side-template-injection.md)
- [IDOR Broken Object Authorization](idor-broken-object-authorization.md)
- [CMDi Command Injection](cmdi-command-injection.md)
- [Path Traversal LFI](path-traversal-lfi.md)
- [CSRF Cross Site Request Forgery](csrf-cross-site-request-forgery.md)
- [API Security Router](api-sec.md)
- [JWT OAuth Token Attacks](jwt-oauth-token-attacks.md)
- [OAuth OIDC Misconfiguration](oauth-oidc-misconfiguration.md)
- [CORS Cross Origin Misconfiguration](cors-cross-origin-misconfiguration.md)
- [SAML SSO Assertion Attacks](saml-sso-assertion-attacks.md)
- [Authentication Bypass](authbypass-authentication-flaws.md)
...
- [Type Juggling (PHP)](type-juggling.md)
...
- [Ghost Bits Cast Attack](ghost-bits-cast-attack.md)
