...
- From **[recon-for-sec](recon-for-sec.md)** — scope-safe discovery, crawling, and fingerprinting before deep VCS tests.
- From **[recon-and-methodology](recon-and-methodology.md)** — structured methodology and evidence handling.
