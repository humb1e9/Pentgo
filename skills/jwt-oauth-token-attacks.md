...
- [oauth oidc misconfiguration](oauth-oidc-misconfiguration.md) for redirect URI, state, nonce, PKCE, and account-binding validation
- [cors cross origin misconfiguration](cors-cross-origin-misconfiguration.md) when browser-readable APIs or token leakage may exist cross-origin
