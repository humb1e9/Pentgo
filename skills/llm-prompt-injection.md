...
- [xss-cross-site-scripting](xss-cross-site-scripting.md) for parallels between XSS (injecting into HTML context) and prompt injection (injecting into LLM context)
- [ssrf-server-side-request-forgery](ssrf-server-side-request-forgery.md) when prompt injection chains into SSRF via tool calls
