...
- [traffic-analysis-pcap](traffic-analysis-pcap.md) for correlating network artifacts with memory findings
- [steganography-techniques](steganography-techniques.md) if hidden data suspected in extracted files
- [windows-privilege-escalation](windows-privilege-escalation.md) for understanding post-exploitation artifacts in memory
