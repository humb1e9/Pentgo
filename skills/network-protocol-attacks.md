...
- [ntlm-relay-coercion](ntlm-relay-coercion.md) for relaying captured NTLM hashes from poisoning attacks
...
- [traffic-analysis-pcap](traffic-analysis-pcap.md) for analyzing captured traffic from MitM
