...
- [Insecure Source Code Management](insecure-source-code-management.md) — .git/.svn/.hg exposure detection
- [Dependency Confusion](dependency-confusion.md) — Supply chain reconnaissance for internal package names
