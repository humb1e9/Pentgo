...
- [linux-privilege-escalation](linux-privilege-escalation.md) or [windows-privilege-escalation](windows-privilege-escalation.md) after landing shell
- [windows-av-evasion](windows-av-evasion.md) when AV blocks shell payloads
