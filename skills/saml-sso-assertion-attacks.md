...
- XML parser attack depth: [xxe xml external entity](xxe-xml-external-entity.md)
- OAuth or OIDC SSO alternatives: [oauth oidc misconfiguration](oauth-oidc-misconfiguration.md)
