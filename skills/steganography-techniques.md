...
- [traffic-analysis-pcap](traffic-analysis-pcap.md) for extracting files from network captures before stego analysis
- [memory-forensics-volatility](memory-forensics-volatility.md) for extracting files from memory dumps
- [classical-cipher-analysis](classical-cipher-analysis.md) if extracted hidden data is further encrypted/encoded
