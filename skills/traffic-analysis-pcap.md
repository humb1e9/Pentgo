...
- [memory-forensics-volatility](memory-forensics-volatility.md) for correlating memory artifacts with network traffic
- [steganography-techniques](steganography-techniques.md) for analyzing files extracted from traffic captures
- [network-protocol-attacks](network-protocol-attacks.md) for understanding attack patterns visible in captures
- [reverse-shell-techniques](reverse-shell-techniques.md) for identifying shell traffic in captures
