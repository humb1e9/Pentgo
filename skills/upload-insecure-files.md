...
- [xss cross site scripting](xss-cross-site-scripting.md) when uploads are rendered in browser contexts
- [xxe xml external entity](xxe-xml-external-entity.md) when SVG, OOXML, or XML imports are accepted
- [cmdi command injection](cmdi-command-injection.md) when a processor, converter, or media pipeline executes system tools
...
| Observation | Pivot |
|---|---|
| SVG or XML accepted | [xxe xml external entity](xxe-xml-external-entity.md) |
| filename or metadata reflected | [xss cross site scripting](xss-cross-site-scripting.md) |
| converter or processor shells out | [cmdi command injection](cmdi-command-injection.md) |
