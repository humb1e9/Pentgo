...
- [sqli-sql-injection](sqli-sql-injection.md) for payloads to deliver after bypassing WAF
- [xss-cross-site-scripting](xss-cross-site-scripting.md) for XSS payloads that need WAF evasion
