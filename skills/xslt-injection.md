...
- **xxe-xml-external-entity** — DTD/entity hardening, generic XML parsers (`xxe-xml-external-entity.md`).
- **ssrf-server-side-request-forgery** — when `document(http:…)` or entity URLs cause server fetches (`ssrf-server-side-request-forgery.md`).
